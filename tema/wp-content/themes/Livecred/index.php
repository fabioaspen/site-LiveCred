        ...
        <div class="row">
            ...
            <aside class="col-lg-4 d-none d-lg-block ">
                    ...
                    <div class="card-body">
                        ...
                        <form>
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Ex: Crédito pessoal">
                ...
                <div class="card text-white mb-4">
                    <img src="assets/img-seguro.jpg" alt="Imagem de mãos segurando sapato" class="card-img">
                    <div class="card-img-overlay bg-banner-header p-0 m-0 row">
                        <div class="col align-self-end">
                            <h5 class="mb-0">Crédito pessoal</h5>
                            <p>Desfrute dos benefícios que você
                            e sua familia merecem</p>
                        </div>
                    </div>
                </div>
                <div class="card text-white mb-4">
                    ...
                    <div class="card border-card-footer">
                        <div class="card-body">
                            <div class="cade-body">
                                <p>
                                    <em>
                                        "Através da realização do curso disponibilizado pelo Estratégia Concursos e das várias questões constantes no material,
                                        além da leitura atenta das leis cobradas na prova, acredito que utilizei ."
                                    </em>
                                </p>
                                <p class="mb-0">
                                    <strong>
